...
function displayResults(honeys) {
    ...
    var sweetness1 = document.getElementById("sweetness1");
    var sourness1 = document.getElementById("sourness1");
    var bitterness1 = document.getElementById("bitterness1");


    var resultText2 = document.getElementById("resultText2");
    var resultImage2 = document.getElementById("resultImage2");
    var sweetness2 = document.getElementById("sweetness2");
    var sourness2 = document.getElementById("sourness2");
    var bitterness2 = document.getElementById("bitterness2");

    // 清空先前的結果
    resultText1.textContent = "";
    resultImage1.src = "";
    sweetness1.textContent = "";
    sourness1.textContent = "";
    bitterness1.textContent = "";

    resultText2.textContent = "";
    resultImage2.src = "";
    sweetness2.textContent = "";
    sourness2.textContent = "";
    bitterness2.textContent = "";

    if (honeys.length >= 0) {
        // 第一種蜂蜜
        resultText1.textContent = honeys[0].name;
        resultImage1.src = honeys[0].name + ".jpg" // 顯示圖片
        sweetness1.textContent = "甜度: " + honeys[0].sweetness;
        sourness1.textContent = "酸度: " + honeys[0].sourness;
        bitterness1.textContent = honeys[0].bitter ? "此蜂蜜有苦味" : "此蜂蜜無苦味";

        // 第二種蜂蜜
        resultText2.textContent = honeys[1].name;
        resultImage2.src = honeys[1].name + ".jpg"; // 顯示圖片
        sweetness2.textContent = "甜度: " + honeys[1].sweetness;
        sourness2.textContent = "酸度: " + honeys[1].sourness;
        bitterness2.textContent = honeys[1].bitter ? "此蜂蜜有苦味" : "此蜂蜜無苦味";
    } else {
        alert("找不到符合您喜好的蜂蜜！");
    }
}
